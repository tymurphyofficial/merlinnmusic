...
const steps = [
  ...
  },
  {
    ...
    imageSrc: "/the-music/step 10.png",
    description:
            ...
            {steps.map((step) => (
              <li key={step.title} className="flex items-start gap-4 sm:gap-8">
                <div className="relative z-10 w-1/3 shrink-0">
                  <div className="relative aspect-square w-full max-w-[240px] overflow-hidden rounded-md bg-[#3a3a3a] shadow-[0_8px_30px_rgba(0,0,0,0.25)]">
                    <Image
                      src={step.imageSrc}
                      alt={step.title}
                      fill
